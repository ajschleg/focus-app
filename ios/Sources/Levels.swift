...
/// One rung of the monk's ladder — the league system (CONCEPT.md §5D) layered
...
struct FocusLevel: Equatable {
    ...
    static let ladder: [FocusLevel] = [
        ...
        FocusLevel(name: "Initiate",    systemImage: "book.closed.fill", tint: .brown,  targetScore: 55, winsToPromote: 2, missesToDemote: 4, promotionReward: 20),
        FocusLevel(name: "Disciple",    systemImage: "figure.walk",      tint: .green,  targetScore: 60, winsToPromote: 3, missesToDemote: 4, promotionReward: 30),
        FocusLevel(name: "Pilgrim",     systemImage: "mountain.2.fill",  tint: .teal,   targetScore: 65, winsToPromote: 3, missesToDemote: 3, promotionReward: 40),
        FocusLevel(name: "Adept",       systemImage: "wind",             tint: .blue,   targetScore: 70, winsToPromote: 4, missesToDemote: 3, promotionReward: 60),
        FocusLevel(name: "Ascetic",     systemImage: "flame.fill",       tint: .indigo, targetScore: 75, winsToPromote: 4, missesToDemote: 3, promotionReward: 80),
        FocusLevel(name: "Sage",        systemImage: "moon.stars.fill",  tint: .purple, targetScore: 80, winsToPromote: 5, missesToDemote: 3, promotionReward: 100),
        FocusLevel(name: "Elder",       systemImage: "sun.max.fill",     tint: .orange, targetScore: 84, winsToPromote: 5, missesToDemote: 3, promotionReward: 150),
        FocusLevel(name: "Master",      systemImage: "sparkles",         tint: .red,    targetScore: 88, winsToPromote: 6, missesToDemote: 3, promotionReward: 200),
        // The ensō at the summit. A full winning streak here "holds the
        // summit": it resets both counters instead of promoting.
        FocusLevel(name: "Enlightened", systemImage: "circle.circle",    tint: .yellow, targetScore: 92, winsToPromote: 6, missesToDemote: 3, promotionReward: 300),
    ]
}
